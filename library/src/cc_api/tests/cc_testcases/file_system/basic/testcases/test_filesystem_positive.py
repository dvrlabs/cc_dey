...
class DiscoveryTestCase(cc_testcase.TestCase):
    ...
    def test_01_send_file_without_path(self):
        """ Sends a put_file request to upload a file to the device without path
        ...
        fileName = "test_01_send_file_without_path.txt"
    ...
    def test_02_send_file_valid_path_without_content(self):
    ...
    def test_03_send_file_valid_path_with_increasing_content(self):
    ...
    def test_04_send_file_valid_path_with_big_content(self):
    ...
    def test_05_send_file_increasing_subdirectories(self):
        """ Sends a put_file request to upload a file to the device on different subdirectory levels from the root path.
        Verifies if the returned response is the expected and the generated file has the expected content.
        """
        ...
        for i in range(1,64):
            ...
            fileName = "test_05_send_file_increasing_subdirectories_%s.txt" % i

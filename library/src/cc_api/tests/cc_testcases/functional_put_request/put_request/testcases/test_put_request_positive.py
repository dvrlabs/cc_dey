...
class PutRequestDvtTestCase(cc_testcase.TestCase):
    ...
    def test_01_put_request_send_option_overwrite_decreasing_bytes(self):
    ...
    def test_02_put_request_send_option_overwrite_increasing_bytes(self):
        """ Sends a put request to upload data over the same file with the overwrite option.
    ...
    def test_03_put_request_send_option_append_decreasing_bytes(self):
    ...
    def test_04_put_request_send_option_overwrite_increasing_bytes(self):
        """ Sends a put request to upload data over the same file with the append option.
    ...
    #def test_05_put_request_send_option_archive_increasing_bytes(self):

...
int main (void)
{
    ...
    ccapi_fs_add_virtual_dir("Sebastian Pastor", "/home/spastor");
    ccapi_fs_add_virtual_dir("Hector Bujanda", "/home/spastor/cc_api");
    ccapi_fs_add_virtual_dir("Arturo Buzarra", "/etc");
    ccapi_fs_add_virtual_dir("Aaron S. Kurland", "/usr/local");
    ccapi_fs_add_virtual_dir("Pedro Perez", "/home");
